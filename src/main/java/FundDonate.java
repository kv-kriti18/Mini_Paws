...
/**
 * Servlet implementation class FundDonate
 */
@WebServlet("/FundDonate")
public class FundDonate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if (insertFundDonate(email, amount)) {
	...
	private boolean insertFundDonate(String email, String amount) {
        ...
        try {
            ...
            String sql = "INSERT INTO fund_donate (email, amount) VALUES (?, ?)";
